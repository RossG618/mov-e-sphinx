    ...
    <div className="overflow-hidden pt-5">
      <div className="recent d-flex position-relative align-items-center   justify-content-center">
        <div className="row row-cols-1 row-cols-xl-2">
          <div className=" col   px-5 pt-5 pb-5 "> 
            ...
            <div className="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-xl-3 row-cols-xxl-4">
              <UpcomingMovies />
            </div>
          </div>
      ...
      <div className="top-rated ">
        <div className="container py-5 z-23">
          ...
          <div className="row row-cols-3 row-cols-lg-4 row-cols-xl-6 mx-auto container justify-content-center">
            <TopRatedMovies />
          </div>
        </div>
      </div>
      ...
      <div className="trial z-23">
        <div className=" container d-flex  py-3 row row-cols-1 row-cols-md-2 justify-content-between mx-auto align-items-center">
          <div className="col">
