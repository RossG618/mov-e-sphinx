...
const Footer = () => {
    return ( <div className="footer bg-dark overflow-idden z-23 ">
    <div className="container pt-4 row row-cols-1 row-cols-xl-4 mx-auto d-flex">
      <div className="col pb-4  flex-column">
      ...
      <div className="text-light col pb-4  text-start">
      ...
      <div className="text-light col pb-4  text-start">
        ...
        <div>
          <div className="rounded-pill border border-4 border-secondary p-0 mt-4 d-flex" style={{width: 'fit-content'}}>
            <input
